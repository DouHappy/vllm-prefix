...
class Qwen2Attention(nn.Module):
    ...
    def forward(
        ...
        # 旧版的 rotary_emb 在 PagedAttentionWithRope中
...
class Qwen2Model(nn.Module):
    ...
    def forward(
        ...
        # with open("/home/yangchunhao/vllmych/vllm-prefix/vllm/model_executor/layers/attention.log", 'a') as f:
        #     print(f"hidden_states {hidden_states.shape}\n{hidden_states[:,:,0]}", file=f)
        return hidden_states
...
class Qwen2ForCausalLM(nn.Module):
    ...
    def __init__(
        ...
        # issue3344: https://github.com/vllm-project/vllm/pull/3344/
    ...
    def forward(
        ...
        # 旧版的 cache_event 是传给模型在 attention 之后处理的
