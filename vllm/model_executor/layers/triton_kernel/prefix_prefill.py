...
if triton.__version__ >= "2.1.0":
    ...
    def _fwd_kernel_alibi(
        Q, K, V, K_cache, V_cache, B_Loc, sm_scale, B_Start_Loc, B_Seqlen, B_Ctxlen, Alibi_slopes, block_size, x,
        Out,
        stride_b_loc_b, stride_b_loc_s,
        stride_qbs, stride_qh, stride_qd,
        stride_kbs, stride_kh, stride_kd,
    ...
    def context_attention_fwd(q, k, v, o, k_cache, v_cache, b_loc, b_start_loc, b_seq_len, b_ctx_len, max_input_len, alibi_slopes = None):
        BLOCK = 32
        # shape constraints
        ...
        if alibi_slopes != None:
            _fwd_kernel_alibi[grid](
                q, k, v, k_cache, v_cache, b_loc, sm_scale, b_start_loc, b_seq_len, b_ctx_len, alibi_slopes, v_cache.shape[3], 8,
                o,
