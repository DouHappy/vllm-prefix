...
class LLMEngine:
    ...
    def delete_prefix(self, prefix_tokens:List[int]) -> int:
        ...
        prefix = self.scheduler.prefix_trie.match(truncated_prefix_token_ids)
        ...
        if prefix_pos is not None:
            ...
            if prefix_pos > 0:
                ...
                if prefix is not None:
                    ...
                    seq.prefix = self.scheduler.prefix_trie.add_prefix(truncated_prefix_token_ids)
    ...
    def _process_model_outputs(
        ...
        # update prefix.on_gpu
        # we assume that all prefix was on gpu after attention
        for seq_group in (scheduled_seq_groups +
                          scheduler_outputs.ignored_seq_groups):
            if seq_group.prefix != None:
